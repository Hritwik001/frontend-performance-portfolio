    ...
    <Section id="case-studies">
      <Container>
        ...
        <div className="mt-16 space-y-10">
          <article className="group rounded-[var(--radius-xl)] border border-[var(--border)] bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-8 shadow-2xl shadow-black/30 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent)] hover:shadow-[0_0_50px_rgba(245,197,66,0.10)] sm:p-10">
            ...
            <div className="mt-6 grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
              <div>
                ...
                <p className="mt-6 leading-8 text-[var(--text-secondary)]">
                  A React and Next.js revenue analytics dashboard with delayed
                  KPI rendering, slow chart loading, laggy subscription search,
                  slow plan filtering, and heavy dashboard refresh behavior.
                </p>
              </div>
              ...
              <div className="rounded-[var(--radius-xl)] border border-[var(--border)] bg-black/40 p-6">
                ...
                <p className="mt-4 text-sm leading-6 text-[var(--text-secondary)]">
                  React Profiler validated a significant render-time reduction
                  after optimization.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-black/30 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
                  Slow KPI loading, delayed revenue charts, laggy search, slow
                  filters, and sluggish dashboard refresh.
                </p>
              </div>
              ...
              <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-black/30 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
                  Removed artificial delays, memoized revenue calculations,
                  optimized search/filtering, and reduced table rendering.
                </p>
              </div>
              ...
              <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-black/30 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
                  Render time improved from 2000ms to 140ms with smoother
            ...
            <div className="mt-10 space-y-6">
              <div className="group/image overflow-hidden rounded-[var(--radius-xl)] border border-[var(--border)] bg-black/30 transition-all duration-300 hover:border-[var(--border-strong)]">
          ...
          <article className="group rounded-[var(--radius-xl)] border border-[var(--border)] bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-8 shadow-2xl shadow-black/30 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent)] hover:shadow-[0_0_50px_rgba(245,197,66,0.10)] sm:p-10">
            ...
            <div className="mt-6 grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
              <div>
                ...
                <p className="mt-6 leading-8 text-[var(--text-secondary)]">
                  A React and Next.js ticketing dashboard with laggy search,
                  slow filters, heavy rendering, expensive ticket processing,
                  and poor responsiveness across a 10,000-ticket dataset.
                </p>
              </div>
              ...
              <div className="rounded-[var(--radius-xl)] border border-[var(--border)] bg-black/40 p-6">
                ...
                <p className="mt-4 text-sm leading-6 text-[var(--text-secondary)]">
                  React Profiler validated a dramatic render-time reduction
                  after optimization.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-black/30 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
                  Laggy search, slow filters, heavy rendering, expensive ticket
                  processing, and poor responsiveness.
                </p>
              </div>
              ...
              <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-black/30 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
                  Memoized dataset generation, optimized filtering, added
                  debounced search, deferred updates, and pagination.
                </p>
              </div>
              ...
              <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-black/30 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
                  Render time improved from 3675ms to 2.3ms with smoother
                  search, filtering, and table interactions.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 overflow-hidden rounded-[var(--radius-xl)] border border-[var(--border)] bg-black/30">
              <div className="flex aspect-[16/9] items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="mt-10 space-y-6">
  <div className="group/image overflow-hidden rounded-[var(--radius-xl)] border border-[var(--border)] bg-black/30">
    <div className="border-b border-[var(--border)] px-5 py-3">
      <p className="text-sm font-semibold uppercase tracking-[0.15em] text-[var(--accent)]">
    ...
    <a href="/images/supportdesk/dashboard.png" target="_blank" rel="noreferrer">
      <Image
