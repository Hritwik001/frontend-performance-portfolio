    ...
    <Section id="case-studies">
      <Container>
        <SectionHeading
          ...
          description="One product built from the ground up, and two documented performance turnarounds — the same engineering discipline applied to building and to fixing."
        />
