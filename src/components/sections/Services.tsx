  ...
  return (
    <Section id="services">
      <Container>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {services.map((service) => {
            ...
            return (
              <article
                key={service.title}
                className="group rounded-[var(--radius-xl)] border border-[var(--border)] bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-7 shadow-2xl shadow-black/25 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent)] hover:shadow-[0_0_50px_rgba(245,197,66,0.10)]"
              >
        ...
        <div className="mt-10 rounded-[var(--radius-xl)] border border-[var(--border)] bg-black/30 p-6">
